...
function openPulse(role){
 const data={
  Owner:{title:"Executive Snapshot",items:[["Sales Today","₱48,650"],["Expenses","₱13,260"],["Est. Profit","₱16,190"],["Alerts","3"]],note:"Business activity today"},
 ...
 document.querySelector(".back").onclick=()=>portal(role);
}
